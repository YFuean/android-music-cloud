...
public class InputView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        inputHit = typedArray.getString(R.styleable.inputView_input_hint);
        ...
        mInput.setHint(inputHit);
        mInput.setInputType(isPassword ? InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD :InputType.TYPE_CLASS_PHONE);
